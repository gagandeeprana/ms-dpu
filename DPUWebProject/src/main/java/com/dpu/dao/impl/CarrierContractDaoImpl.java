...
public class CarrierContractDaoImpl extends GenericDaoImpl<CarrierContract> implements CarrierContractDao{
	...
	public List<CarrierContract> findAllCarrierContract(Session session) {
		 //StringBuilder sb = new StringBuilder(" select cc from CarrierContract cc join fetch cc.carrier join fetch cc.arrangedWith join fetch cc.driver join fetch cc.currency " )
